...
if(isset($_POST['submit'])){
   ...
   $update_profile_name =  mysqli_query($conn,"UPDATE db.admins SET name = '$name' WHERE id = '$admin_id'");
   ...
   if($old_pass == $empty_pass){
      ...
      if($new_pass != $empty_pass){
         $update_admin_pass =  mysqli_query($conn,"UPDATE db.admins SET password = '$confirm_pass' WHERE id = '$admin_id'");
